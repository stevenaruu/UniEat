function validate() {
    ...
    let name = document.getElementById("tenant").value.trim();
    let email = document.getElementById("email").value;
    let phone = document.getElementById("phoneNumber").value;
    let pict = document.getElementById("image").value;
    ...
    if(pict === "") {
        ...
        error[3].innerHTML = "Gambar harus diisi";
        ...
        error[3].innerHTML = "";
        redInput[3].style.borderColor = "none";
        redInput[3].style.boxShadow = "0 0 0 0";
